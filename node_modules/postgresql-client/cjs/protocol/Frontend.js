...
const SmartBuffer_js_1 = require("./SmartBuffer.js");
...
class Frontend {
    constructor() {
        this._io = new SmartBuffer_js_1.SmartBuffer();
    }
    ...
    getBindMessage(args) {
        ...
        const columnFormat = queryOptions.columnFormat != null ? queryOptions.columnFormat : definitions_js_1.DEFAULT_COLUMN_FORMAT;
