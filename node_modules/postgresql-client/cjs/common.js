...
const parse_array_js_1 = require("./util/parse-array.js");
...
function wrapRowDescription(typeMap, fields, columnFormat) {
    return fields.map((f, idx) => {
        ...
        const x = {
            ...
            dataTypeName: definitions_js_1.DataTypeNames[f.dataTypeId] || "",
        ...
        if (x.isArray) {
            ...
            for (const oid of Object.keys(definitions_js_1.DataTypeNames)) {
                if (definitions_js_1.DataTypeNames[oid] === x.elementDataTypeName)
