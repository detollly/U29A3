...
exports.DateType = {
    name: "date",
    oid: definitions_js_1.DataTypeOIDs.date,
    jsType: "Date",
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.date);
...
exports.ArrayDateType = {
    ...exports.DateType,
    name: "_date",
    oid: definitions_js_1.DataTypeOIDs._date,
    elementsOID: definitions_js_1.DataTypeOIDs.date,
};
