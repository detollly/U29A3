...
exports.JsonbType = {
    name: "jsonb",
    oid: definitions_js_1.DataTypeOIDs.jsonb,
    jsType: "string",
    parseBinary(v, options) {
        const buf = new BufferReader_js_1.BufferReader(v);
        if (buf.readUInt8() !== 1)
            throw new Error("Unexpected Jsonb version value in header");
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.json);
...
exports.ArrayJsonbType = {
    ...exports.JsonbType,
    name: "_jsonb",
    oid: definitions_js_1.DataTypeOIDs._jsonb,
    elementsOID: definitions_js_1.DataTypeOIDs.jsonb,
};
