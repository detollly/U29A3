...
exports.TimestampType = {
    name: "timestamp",
    oid: definitions_js_1.DataTypeOIDs.timestamp,
    jsType: "Date",
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.timestamp);
    ...
    parseText(v, options) {
        if (options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.timestamp))
            return v;
...
exports.ArrayTimestampType = {
    ...exports.TimestampType,
    name: "_timestamp",
    oid: definitions_js_1.DataTypeOIDs._timestamp,
    elementsOID: definitions_js_1.DataTypeOIDs.timestamp,
};
