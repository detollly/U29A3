...
exports.TimeType = {
    name: "time",
    oid: definitions_js_1.DataTypeOIDs.time,
    jsType: "string",
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.time);
    ...
    parseText(v, options) {
        if (options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.time))
            return v;
...
exports.ArrayTimeType = {
    ...exports.TimeType,
    name: "_time",
    oid: definitions_js_1.DataTypeOIDs._time,
    elementsOID: definitions_js_1.DataTypeOIDs.time,
};
