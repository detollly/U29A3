...
exports.TimestamptzType = {
    name: "timestamptz",
    oid: definitions_js_1.DataTypeOIDs.timestamptz,
    jsType: "Date",
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.timestamptz);
    ...
    parseText(v, options) {
        ...
        if (options.fetchAsString && options.fetchAsString.includes(definitions_js_1.DataTypeOIDs.timestamptz)) {
...
exports.ArrayTimestamptzType = {
    ...exports.TimestamptzType,
    name: "_timestamptz",
    oid: definitions_js_1.DataTypeOIDs._timestamptz,
    elementsOID: definitions_js_1.DataTypeOIDs.timestamptz,
};
