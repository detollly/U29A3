...
class Cursor extends SafeEventEmitter_js_1.SafeEventEmitter {
            ...
            if (r && r.rows && r.rows.length) {
                if (this._parsers) {
                    ...
                    for (let i = 0; i < rows.length; i++) {
                        const row = rows[i];
                        (0, common_js_1.parseRow)(this._parsers, row, this._queryOptions);
                        if (objectRows)
                            rows[i] = (0, common_js_1.convertRowToObject)(fields, row);
                    }
                }
